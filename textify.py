...
def remove_excluded_words(str_list):
    stopwords = ['radio', 'edit', 'ft.', 'feat.',
                 'ms.', 'with', 'the', 'mix', 'bonus', 'track']
...
def clean_string(str):
    ...
    return ' '.join(fully_clean)


# Takes a string and makes it a set (a list with no duplicates).
def setifyString(string):
